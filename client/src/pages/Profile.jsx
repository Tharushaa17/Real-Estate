...
const Profile = () => {
  ...
  const handleChange = (e) => {
    setFormData({ ...setFormData, [e.target.id]:e.target.value})
  }
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input type='text' className='border p-3 rounded-lg' placeholder='Username' defaultValue={currentUser.username} id='username'onChange={handleChange}/> 
        <input type='email' className='border p-3 rounded-lg' placeholder='Email' defaultValue={currentUser.email} id='email'onChange={handleChange}/> 
